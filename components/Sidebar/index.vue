<template>
  <div>
    ...
    >
      <div
        class="overflow-y-auto py-5 pl-3 h-full bg-cyan-500 dark:bg-gray-800 dark:border-gray-700 overflow-x-hidden"
      >
        ...
        <ul class="space-y-2 select-none">
          <li
            v-for="(menu, i) in props.menu"
            :key="i"
            class="relative navigate"
          >
            <NuxtLink
              v-if="!menu.dropdown"
              :to="menu.to"
      ...
      <div
        class="absolute bottom-0 left-0 justify-center p-4 space-x-4 w-full flex dark:bg-gray-800 z-20 dark:border-gray-700"
      >
        <a
          href="#"
          class="inline-flex justify-center p-2 text-white rounded cursor-pointer dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-600"
        >
          <svg
            aria-hidden="true"
            class="w-6 h-6"
        ...
        <a
          ...
          class="inline-flex justify-center p-2 text-white rounded cursor-pointer dark:text-gray-400 dark:hover:text-white hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-600"
        >
          <svg
            aria-hidden="true"
            class="w-6 h-6"
        ...
        <button
          ...
          class="inline-flex justify-center p-2 text-white rounded cursor-pointer dark:hover:text-white dark:text-gray-400 hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-600"
        >
          <svg
            aria-hidden="true"
...
import type { typeMenu } from "~/utils/utilTypes";
