<template>
  <div
    class="modal fade"
    id="kt_modal_add_title"
    ref="addTitleModalRef"
    tabindex="-1"
    aria-hidden="true"
  ...
  >
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
      ...
      <div class="modal-content">
        <!--begin::Modal header-->
        <div class="modal-header" id="kt_modal_add_title_header">
          <!--begin::Modal title-->
...
export default defineComponent({
  name: "add-title-modal",
  components: { Multiselect },
  props: { reload: Function },
  setup(_, { emit }) {
    const formRef = ref<null | HTMLFormElement>(null);
    const addTitleModalRef = ref<null | HTMLElement>(null);
        ...
        if (valid) {
          ...
          if (save.status == 200) {
            ...
            Swal.fire({
              ...
              hideModal(addTitleModalRef.value);
              emit("reload");
            });
          } else {
            Swal.fire({
