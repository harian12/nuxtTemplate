  ...
  >
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
      ...
      <div class="modal-content">
        <!--begin::Modal header-->
        <div class="modal-header" id="kt_modal_view_jenis_header">
          <!--begin::Modal title-->
          <h2 class="fw-bold">
            {{ formData.editForm == "edit" ? "Update" : "View" }} Jenis Bank
            Transfer
          </h2>
          <!--end::Modal title-->
        ...
        >
          ...
          <div class="modal-body py-10 px-lg-17">
            ...
            <div
              ...
              id="kt_modal_view_jenis_scroll"
              data-kt-scroll="true"
              data-kt-scroll-activate="{default: false, lg: true}"
              data-kt-scroll-max-height="auto"
              data-kt-scroll-dependencies="#kt_modal_view_jenis_header"
              data-kt-scroll-wrappers="#kt_modal_view_jenis_scroll"
                ...
                <div class="col-6 mb-2 fv-row">
                  ...
                  >
                    <input
                      ...
                      v-model="formData.va"
                      :disabled="formData.editForm !== 'edit'"
                    />
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    watch(
      ...
      (view) => {
        formData.value.company = String(view.company);
        formData.value.faktif = view.faktif;
        formData.value.va = view.va;
        formData.value.jenis = view.jenis;
        formData.value.id = view.id;
        formData.value.editForm = view.editForm;
      }
    );

    const setFormData = (value) => {
      formData.value.company = String(value.company);
      formData.value.faktif = value.faktif;
      formData.value.va = value.va;
      formData.value.jenis = value.jenis;
      formData.value.id = value.id;
      formData.value.editForm = value.editForm;
    };
      ...
      formRef.value.validate(async (valid: boolean) => {
        if (valid) {
          ...
          const save = {
            ...
            bank_transfer_id: formData.value.id,
          };

          await ApiService.put("bank-transfer", save).then((data) => {
