<template>
  <div
    class="modal fade"
    id="kt_modal_add_pekerjaan"
    ref="addPekerjaanModalRef"
    tabindex="-1"
    aria-hidden="true"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header" id="kt_modal_add_pekerjaan_header">
          <!--begin::Modal title-->
          <h2 class="fw-bold">Add Pekerjaan</h2>
          <!--end::Modal title-->

          <!--begin::Close-->
          <div
            id="kt_modal_add_pekerjaan_close"
...
export default defineComponent({
  name: "add-pekerjaan-modal",
  components: { Multiselect },
  props: { reload: Function },
  setup(_, { emit }) {
    const formRef = ref<null | HTMLFormElement>(null);
    const addPekerjaanModalRef = ref<null | HTMLElement>(null);
    const loading = ref<boolean>(false);
    const formData = ref({
      master_name: "Pekerjaan",
      type1: "input manual",
      value1: "",
      type2: "input manual",
      value2: "",
        ...
        if (valid) {
          ...
          if (save.status == 200) {
            ...
            Swal.fire({
              ...
              hideModal(addPekerjaanModalRef.value);
              emit("reload");
            });
          } else {
            Swal.fire({
