<template>
  <div
    class="modal fade"
    id="kt_modal_add_display"
    ref="addDisplayModalRef"
    tabindex="-1"
    aria-hidden="true"
  ...
  >
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
      ...
      <div class="modal-content">
        <!--begin::Modal header-->
        <div class="modal-header" id="kt_modal_add_display_header">
          <!--begin::Modal title-->
          <h2 class="fw-bold">Add Informasi Alamat Display</h2>
          <!--end::Modal title-->

          <!--begin::Close-->
          <div
            id="kt_modal_add_display_close"
...
export default defineComponent({
  name: "add-display-modal",
  components: { Multiselect },
  props: { reload: Function },
  setup(_, { emit }) {
    const formRef = ref<null | HTMLFormElement>(null);
    const addDisplayModalRef = ref<null | HTMLElement>(null);
    const submitButtonRef = ref<null | HTMLButtonElement>(null);
    const loading = ref<boolean>(false);
    const formData = ref({
      master_name: "Informasi alamat display",
      type1: "input manual",
      value1: "",
      type2: "input manual",
      value2: "",
      ...
      formRef.value.validate(async (valid: boolean) => {
        if (valid) {
          ...
          const saveData = {
            ...
            master_name: "Informasi alamat display",
            code_penunjang: 757712,
            code: "IAD",
          };

          await ApiService.post("penunjang", saveData).then((data) => {
            if (data.data.status_code == 200) {
              ...
              Swal.fire({
                ...
                hideModal(addDisplayModalRef.value);
                emit("reload");
              });
            } else {
              Swal.fire({
