  ...
  >
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
      ...
      <div class="modal-content">
        <!--begin::Modal header-->
        <div class="modal-header" id="kt_modal_add_lens_header">
          <!--begin::Modal title-->
          <h2 class="fw-bold">Add Type Contact Lens</h2>
          <!--end::Modal title-->

          <!--begin::Close-->
          <div
            id="kt_modal_add_lens_close"
...
export default defineComponent({
  ...
  setup(_, { emit }) {
    ...
    const addLensModalRef = ref<null | HTMLElement>(null);
    const submitButtonRef = ref<null | HTMLButtonElement>(null);
    const loading = ref<boolean>(false);
    const formData = ref({
      master_name: "Type contact lens",
      type1: "input manual",
      value1: "",
      type2: "input manual",
      value2: "",
        ...
        if (valid) {
          ...
          if (save.status == 200) {
            ...
            Swal.fire({
              ...
              hideModal(addLensModalRef.value);
              emit("reload");
            });
          } else {
            Swal.fire({
