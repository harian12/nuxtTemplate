<template>
  <div
    class="modal fade"
    id="kt_modal_add_agama"
    ref="addAgamaModalRef"
    tabindex="-1"
    aria-hidden="true"
  ...
  >
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
      ...
      <div class="modal-content">
        <!--begin::Modal header-->
        <div class="modal-header" id="kt_modal_add_agama_header">
          <!--begin::Modal title-->
          <h2 class="fw-bold">Add Agama</h2>
          <!--end::Modal title-->

          <!--begin::Close-->
          <div
            id="kt_modal_add_agama_close"
...
export default defineComponent({
  name: "add-agama-modal",
  components: { Multiselect },
  props: { reload: Function },
  setup(_, { emit }) {
    const formRef = ref<null | HTMLFormElement>(null);
    const addAgamaModalRef = ref<null | HTMLElement>(null);
        ...
        if (valid) {
          ...
          if (save.status == 200) {
            ...
            Swal.fire({
              ...
              hideModal(addAgamaModalRef.value);
              emit("reload");
            });
          } else {
            Swal.fire({
