<template>
  <div
    class="modal fade"
    id="kt_modal_add_setoran"
    ref="addSetoranModalRef"
    tabindex="-1"
    aria-hidden="true"
  ...
  >
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
      ...
      <div class="modal-content">
        <!--begin::Modal header-->
        <div class="modal-header" id="kt_modal_add_setoran_header">
          <!--begin::Modal title-->
          <h2 class="fw-bold">Add Jenis Setoran</h2>
          <!--end::Modal title-->

          <!--begin::Close-->
          <div
            id="kt_modal_add_setoran_close"
...
export default defineComponent({
  name: "add-setoran-modal",
  components: { Multiselect },
  props: { reload: Function },
  setup(_, { emit }) {
    const formRef = ref<null | HTMLFormElement>(null);
    const submitButtonRef = ref<null | HTMLButtonElement>(null);
    const addSetoranModalRef = ref<null | HTMLElement>(null);
    const loading = ref<boolean>(false);
    const formData = ref({
      master_name: "Jenis setoran",
      type1: "input manual",
      value1: "",
      type2: "input manual",
      value2: "",
        ...
        if (valid) {
          ...
          if (save.status == 200) {
            ...
            Swal.fire({
              ...
              hideModal(addSetoranModalRef.value);
              emit("reload");
            });
          } else {
            Swal.fire({
