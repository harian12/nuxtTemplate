  ...
  >
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
      ...
      <div class="modal-content">
        <!--begin::Modal header-->
        <div class="modal-header" id="kt_modal_add_fnt_header">
          <!--begin::Modal title-->
          <h2 class="fw-bold">Add Fintech</h2>
          <!--end::Modal title-->

          <!--begin::Close-->
          <div
            id="kt_modal_add_fnt_close"
        ...
        >
          ...
          <div class="modal-body py-10 px-lg-17">
            ...
            <div
              ...
              id="kt_modal_add_fnt_scroll"
              data-kt-scroll="true"
              data-kt-scroll-activate="{default: false, lg: true}"
              data-kt-scroll-max-height="auto"
              data-kt-scroll-dependencies="#kt_modal_add_fnt_header"
              data-kt-scroll-wrappers="#kt_modal_add_fnt_scroll"
    ...
    const submit = () => {
      ...
      formRef.value.validate(async (valid: boolean) => {
        if (valid) {
          ...
          await ApiService.post("disc-rate-online/fintech", save).then(
            (data) => {
