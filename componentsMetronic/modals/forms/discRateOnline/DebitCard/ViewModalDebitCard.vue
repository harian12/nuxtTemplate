  ...
  >
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
      ...
      <div class="modal-content">
        <!--begin::Modal header-->
        <div class="modal-header" id="kt_modal_edit_dc_header">
          <!--begin::Modal title-->
          <h2 class="fw-bold">
            {{ formData.editModal == "edit" ? "Update" : "View" }} Data bank
            Transfer
          </h2>
          <!--end::Modal title-->
        ...
        >
          ...
          <div class="modal-body py-10 px-lg-17">
            ...
            <div
              ...
              id="kt_modal_edit_dc_scroll"
              data-kt-scroll="true"
              data-kt-scroll-activate="{default: false, lg: true}"
              data-kt-scroll-max-height="auto"
              data-kt-scroll-dependencies="#kt_modal_edit_dc_header"
              data-kt-scroll-wrappers="#kt_modal_edit_dc_scroll"
      ...
      formRef.value.validate(async (valid: boolean) => {
        if (valid) {
          ...
          const save = {
            ...
            disc_rate_on_debit_card_id: formData.value.id,
          };

          await ApiService.put("disc-rate-online/debit-card", save).then(
            (data) => {
