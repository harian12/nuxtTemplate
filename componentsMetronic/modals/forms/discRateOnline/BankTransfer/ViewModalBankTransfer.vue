      ...
      formRef.value.validate(async (valid: boolean) => {
        if (valid) {
          ...
          const save = {
            ...
            disc_rate_on_bank_transfer_id: formData.value.id,
          };

          await ApiService.put("disc-rate-online/bank-transfer", save).then(
            (data) => {
