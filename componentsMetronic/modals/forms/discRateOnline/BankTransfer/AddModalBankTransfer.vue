  ...
  >
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
      ...
      <div class="modal-content">
        <!--begin::Modal header-->
        <div class="modal-header" id="kt_modal_add_bank_transfer_header">
          <!--begin::Modal title-->
          <h2 class="fw-bold">Add Data bank Transfer</h2>
          <!--end::Modal title-->

          <!--begin::Close-->
          <div
            id="kt_modal_add_bank_transfer_close"
        ...
        >
          ...
          <div class="modal-body py-10 px-lg-17">
            ...
            <div
              ...
              id="kt_modal_add_bank_transfer_scroll"
              data-kt-scroll="true"
              data-kt-scroll-activate="{default: false, lg: true}"
              data-kt-scroll-max-height="auto"
              data-kt-scroll-dependencies="#kt_modal_add_bank_transfer_header"
              data-kt-scroll-wrappers="#kt_modal_add_bank_transfer_scroll"
      ...
      formRef.value.validate(async (valid: boolean) => {
        if (valid) {
          ...
          const save = {
            ...
            card_center_id: formData.value.merchant,
          ...
          await ApiService.post("disc-rate-online/bank-transfer", save).then(
            (data) => {
