  ...
  >
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
      ...
      <div class="modal-content">
        <!--begin::Modal header-->
        <div class="modal-header" id="kt_modal_edit_cc_header">
          <!--begin::Modal title-->
          <h2 class="fw-bold">
            {{ formData.editModal == "edit" ? "Update" : "View" }} Data Credit
            Card
          </h2>
          <!--end::Modal title-->
        ...
        >
          ...
          <div class="modal-body py-10 px-lg-17">
            ...
            <div
              ...
              id="kt_modal_edit_cc_scroll"
              data-kt-scroll="true"
              data-kt-scroll-activate="{default: false, lg: true}"
              data-kt-scroll-max-height="auto"
              data-kt-scroll-dependencies="#kt_modal_edit_cc_header"
              data-kt-scroll-wrappers="#kt_modal_edit_cc_scroll"
                ...
                <div class="col-6 mb-2 fv-row">
                  ...
                  <el-form-item prop="merchant_id">
                    <Multiselect
                      ...
                      @click="CopyEvent(formData.merchant_id, 'merchant')"
                    ></Multiselect>
                  </el-form-item>
                </div>
                <div class="col-6 mb-2 fv-row">
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const filterList = async () => {
      ...
      await ApiService.get("bank-transfer").then((data) => {
        data.data.data.forEach((val) => {
          jenis.push({
            value: val.bank_transfer_id,
            label: val.jenis_bank_transfer,
          });
        });
      });
      ...
      formRef.value.validate(async (valid: boolean) => {
        if (valid) {
          ...
          const save = {
            ...
            disc_rate_on_credit_card_id: formData.value.id,
            merchant_id: formData.value.merchant_id,
          };

          await ApiService.put("disc-rate-online/credit-card", save).then(
            (data) => {
