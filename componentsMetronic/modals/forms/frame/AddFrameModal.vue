<template>
  <div
    class="modal fade"
    id="kt_modal_add_frame"
    ref="addFrameModalRef"
    tabindex="-1"
    aria-hidden="true"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header" id="kt_modal_add_frame_header">
          <!--begin::Modal title-->
          <h2 class="fw-bold">Add Kategori Frame</h2>
          <!--end::Modal title-->

          <!--begin::Close-->
          <div
            id="kt_modal_add_frame_close"
...
export default defineComponent({
  name: "add-frame-modal",
  components: { Multiselect },
  props: { reload: Function },
  setup(_, { emit }) {
    const formRef = ref<null | HTMLFormElement>(null);
    const addFrameModalRef = ref<null | HTMLElement>(null);
    const submitButtonRef = ref<null | HTMLButtonElement>(null);
    const loading = ref<boolean>(false);
    const formData = ref({
      master_name: "Kategori frame",
      type1: "input manual",
      value1: "",
      type2: "input manual",
      value2: "",
        ...
        if (valid) {
          ...
          if (save.status == 200) {
            ...
            Swal.fire({
              ...
              hideModal(addFrameModalRef.value);
              emit("reload");
            });
          } else {
            Swal.fire({
