    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header" id="kt_modal_add_stock_header">
          <!--begin::Modal title-->
          <h2 class="fw-bold">Add Pengambilan Stock Dari</h2>
          <!--end::Modal title-->

          <!--begin::Close-->
          <div
            id="kt_modal_add_stock_close"
...
export default defineComponent({
  ...
  setup(_, { emit }) {
    ...
    const addStockModalRef = ref<null | HTMLElement>(null);
    const loading = ref<boolean>(false);
    const formData = ref({
      master_name: "Pengambilan stock dari",
      type1: "input manual",
      value1: "",
      type2: "input manual",
      value2: "",
    ...
    const submit = () => {
      ...
      formRef.value.validate(async (valid: boolean) => {
        if (valid) {
          ...
          if (formData.value.value1 === "" || formData.value.value1 === null) {
            Swal.fire({
              text:
          ...
          if (save.status == 200) {
            ...
            Swal.fire({
              ...
              hideModal(addStockModalRef.value);
              emit("reload");
            });
          } else {
            Swal.fire({
